...
public class PowerSupplyFailureReportPositiveForControllerTest extends CallHomeTestBase
{
	
	@Test ( description = "Power supply failure report positive for Controller", groups = { "CHEmail" } )
	public void TC10082() throws Exception
	{
