...
public class CleaningPositiveTest extends CallHomeTestBase
{
	@SuppressWarnings("deprecation")
	@Test ( description = "Cleaning Positive", groups = { "CHEmail" } )
	public void TC9934() throws Exception
	{
	    ...
	    db.waitTillRecordDisappeared(eventRec, TIMEOUT * 2, INTERVAL);
	    Assert.assertTrue(!db.isRecordExists(eventRec), "Event has not been removed");
	}
}
