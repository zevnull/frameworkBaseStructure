...
public class PowerSupplyFailureReportPositiveForEnclosureTest extends CallHomeTestBase
{
	
	@Test ( description = "Power supply failure report positive for Enclosure", groups = { "CHEmail" } )
	public void TC10065() throws Exception
	{
	    ...
	    Assert.assertTrue(!email.waitForEmailWithCountAppeared(4, TIMEOUT * 7), "Wrong count of emails");
	}
}
