...
public class SingleControllerPowerSupplyFailureTest extends CallHomeTestBase
{
	
	@Test ( description = "Single controller power supply failure", groups = { "CHEmail" } )
	public void TC10084() throws Exception
	{
	    ...
	    Assert.assertTrue(!email.waitForEmailWithCountAppeared(2, TIMEOUT * 2), "Wrong count of emails");
