...
public class UIResultSortingInAscendingDirectionTest extends CallHomeTestBase
{
	
	@Test ( description = "UI result sorting in ascending direction", groups = { "CHEmail" } )
	public void TC9016() throws Exception
	{
