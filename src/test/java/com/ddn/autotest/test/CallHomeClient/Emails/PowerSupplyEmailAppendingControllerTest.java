...
public class PowerSupplyEmailAppendingControllerTest extends CallHomeTestBase
{
	
	@Test ( description = "Power supply email appending Controller", groups = { "CHEmail" } )
	public void TC10073() throws Exception
	{
		...
		Event eventPowerSupply = new Event(new SFAPowerSupplyControllerComponent(enclInd));
