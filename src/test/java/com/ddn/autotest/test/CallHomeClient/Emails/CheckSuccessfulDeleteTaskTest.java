...
public class CheckSuccessfulDeleteTaskTest extends CallHomeTestBase
{
	
	@Test ( description = "Check successful delete task", groups = { "CHEmail" } )
	public void TC8921() throws Exception
	{
